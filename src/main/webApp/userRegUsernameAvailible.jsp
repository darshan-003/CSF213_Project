...
<form action="/registerUser" name="studentForm" onsubmit="submitForm();">
    ...
    <div class="form-group">
        <button type="submit" class="btn btn-success btn-lg btn-block" onsubmit="submitForm();">Register Now</button>
    </div>
